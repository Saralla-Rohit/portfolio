...
const About = ({isDarkMode}) => {
  return (
    ...
    whileInView={{opacity:1,y:0}} transition={{duration:0.5,delay:0.5}} className='text-center text-5xl font-Ovo'>About me</motion.h2>
      <motion.div initial={{opacity:0}}
    whileInView={{opacity:1}} transition={{duration:0.8}}  className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        <motion.div 
    ...
    whileInView={{opacity:1}} transition={{duration:0.6,delay:0.8}} 
     className='flex-1'>
            <p className='mb-10 max-w-21 font-Ovo'>I specialize in full-stack web development using the MERN stack, creating problem solving web application,Integrating UI design with back-end development.</p>
            <motion.ul
            initial={{opacity:0}}
